...
% Por exemplo, se chamarmos a função GCD(24, 36), o módulo Datapath realizará as seguintes operações:
% \begin{enumerate}
%     \item Carregar os valores 24 e 36 nos registradores A e B.
%     \item Utilizar o comparação aritmética \texttt{lt - "Less Than"} para verificar os valores de A e B.
%     \item Utilizar os multiplexadores para selecionar os valores corretos com base no resultado da comparação.
%     \item Subtrair o menor valor do maior valor até que um dos valores seja zero.
%     \item Comparar os valores de A e B para determinar a ordem correta das operações.
%     \item Subtrair o menor valor do maior valor até que um dos valores seja zero.
%     \item Retornar o valor restante como o GCD.
%     \item Atualizar o módulo de Controle com o resultado, gerando um sinal de saída para indicar a conclusão do cálculo.
%     \item Aguardar a solicitação de um novo cálculo.
%     \item Reiniciar o processo com novos valores de entrada.
% \end{enumerate}
